    ...
    map = <GoogleMapReact
          ...
          if(geoJsonLayer){
            ...
            if( data.displayHeatmap){
              ...
              heatmap.set('radius',  data.heatmapRadius);
              heatmap.set('opacity',  data.heatmapOpacity);
              heatmap.set('dissipating',  data.heatmapDissipating);
              heatmap.set('maxIntensity',  data.heatmapMaxIntensity);                
